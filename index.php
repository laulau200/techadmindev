    ...
    <nav class="fixed w-full z-50 gradient-bg text-white shadow-lg">
        <div class="container mx-auto px-6 py-3 flex justify-between items-center">
            ...
            <div class="hidden md:flex space-x-8">
                ...
                <a href="#services" class="nav-link">Compétences</a>
                <a href="#portfolio" class="nav-link">Sport</a>
        ...
        <div class="md:hidden hidden gradient-bg w-full px-6 pb-4" id="mobile-menu">
            <div class="flex flex-col space-y-3">
                ...
                <a href="#about" class="nav-link py-2">A propos</a>
                <a href="#services" class="nav-link py-2">Compétences</a>
                <a href="#portfolio" class="nav-link py-2">Sport</a>
    ...
    <!-- section boutons -->
        <nav>
            <ul>
                ...
                <li><a href="pages/loisir.php">Sport</a></li>
        ...
        <div class="container mx-auto px-6 py-20 flex flex-col md:flex-row items-center">
            <div class="md:w-1/2 fade-in">
                ...
                <div class="flex space-x-4">
                    ...
                    <button class="border-2 border-white hover:bg-white hover:text-gray-900 text-white font-bold py-3 px-6 rounded-full transition duration-300 transform hover:scale-105">
                        <a href="./pages/loisir.php">Sport</a> 
                    </button>
            ...
            <div style="display:inline-block;vertical-align:top;" class="md:w-1/2 mt-10 md:mt-0 fade-in">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="#about" class="text-gray-400 hover:text-white transition">A propos</a></li>
                        <li><a href="#services" class="text-gray-400 hover:text-white transition">Compétences</a></li>
                        <li><a href="#portfolio" class="text-gray-400 hover:text-white transition">Sport</a></li>
